...
- смотреть список задач (все / выполненные / невыполненные / высокий приоритет / просроченные)
...
list                          — все задачи
list done                     — выполненные
list incomplete               — невыполненные
list high                     — высокий приоритет
list overdue                  — просроченные
